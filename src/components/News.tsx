...
const News = () => {
  ...
  const latestNews = [
    { id: 1, title: 'NBPKOREA, 2025년 신기술 발표', date: '2025.06.30', link: '/rnd' },
    { id: 2, title: '환경 솔루션 사업부, 친환경 인증 획득', date: '2025.06.25', link: '/rnd' },
    { id: 3, title: '산업용 버너 효율 개선 성공 사례', date: '2025.06.20', link: '/rnd' },
  ];
            ...
            <div className="space-y-6">
              {latestNews.map((newsItem, index) => (
                <div key={newsItem.id} className="group cursor-pointer">
                  <Link href={newsItem.link} className="block p-4 rounded-xl hover:bg-gray-50 transition-all duration-300 border border-transparent hover:border-secondary/20">
          ...
          >
            <div className="w-16 h-16 bg-gray-100 rounded-2xl flex items-center justify-center mx-auto mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
                <Link href="/support" className="inline-flex items-center justify-center bg-gradient-to-r from-primary to-accent hover:from-accent hover:to-primary text-white font-semibold py-3 px-8 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
