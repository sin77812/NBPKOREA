    ...
    >
      ...
      <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link href="/products" className="bg-accent hover:bg-orange-600 text-white font-bold py-3 px-6 sm:px-8 rounded-full transition duration-300 w-full sm:w-auto text-sm sm:text-base text-center">
            제품/솔루션 자세히 보기
          </Link>
          <Link href="/support" className="bg-transparent border-2 border-white hover:bg-white hover:text-black text-white font-bold py-3 px-6 sm:px-8 rounded-full transition duration-300 w-full sm:w-auto text-sm sm:text-base text-center">
            문의하기
          </Link>
        </div>
      </div>
