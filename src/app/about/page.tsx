    ...
    <div className="bg-background text-text-primary">
        ...
        <section className="relative h-[50vh] md:h-[60vh] flex items-center justify-center text-white overflow-hidden">
            ...
            <div className="relative z-10 text-center px-4">
                ...
                <motion.p 
                    className="text-base md:text-lg lg:text-xl max-w-3xl mx-auto font-inter px-4"
                    initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }}
                >
                    NBPKOREA는 깨끗한 환경과 효율적인 에너지 솔루션을 통해 <br />
                    지속 가능한 미래를 만들어간다는 비전으로 시작되었습니다.
                    저희는 연소 기술, 환경 설비, 그리고 프리미엄 커피 사업에 이르기까지 <br />
                    각 분야에서 최고의 전문성과 열정으로 고객과 사회에 기여하고 있습니다.
                </motion.p>
            </div>
        </section>
